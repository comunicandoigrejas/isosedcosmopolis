...
# --- 4. ESTILO CSS (Contraste Total e Forçado) ---
st.markdown("""
    <style>
    ...
    /* FORÇAR CORES NOS BOTÕES (Gatilhos de Classe) */
    ...
    .btn-aniv button { background-color: #f1c40f !important; color: #000000 !important; } /* Texto preto no amarelo */
    .btn-leitura button { background-color: #ff7675 !important; }

    /* CARDS DE ANIVERSÁRIO */
    .card-niver {
        width: 135px !important; height: 85px !important;
    ...
    .niver-data { font-size: 0.9em !important; font-weight: bold; color: #FFFFFF !important; }
    </style>
